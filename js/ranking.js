$(function() {
	...
	sercice('https://www.easy-mock.com/mock/5a5dc59cd467601e4b7f5731/game/ranking',function(data){
		var myPhoto = data.body.myPhoto ? "http://artapp-dev-bucket.oss-cn-beijing.aliyuncs.com/" + data.body.myPhoto : "img/lufei.jpg";
		...
		for (var i = 0; i < contestRanking.length; i ++) {			
			var userPhoto = contestRanking[i].userPhoto ? "http://artapp-dev-bucket.oss-cn-beijing.aliyuncs.com/" + contestRanking[i].userPhoto : "img/photo.png";
